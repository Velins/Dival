...
Дякую за надання вихідного коду бібліотеки liqpay3. Ваш код для створення замовлення та оплати виглядає правильним, за винятком деяких деталей, які потребують корекції.

Переконайтеся, що ви використовуєте правильні методи з класу LiqPay. Зокрема, замість cnb_data, використовуйте метод cnb_form, який повертає HTML-форму для оплати.
